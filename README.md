...
این پروژه یک سایت فروشگاهی مخصوص فروش کتاب است. این یک پروژه تمرینی است و قسمت Back-End این سایت با فریمورک Django طراحی شده است و در قسمت Front-End آن از یک قالب آماده استفاده شده است. فسمت های مختلف سایت و قابلیت های به شرح زیر است :
